...
?> 
    ...
    <div id="container">
        ...
        <form action="admin2A.php" method="post" enctype="multipart/form-data">
            ...
            <!-- J'ai ajouté min et max pour la date-->
            <input type="datetime-local" name="item_date" min="2020-04-27T00:00:00" max="2021-01-01T00:00:00" required><br>
